...
pdb = PDBFile("pfoa/pfoa_dock_luxr_1.pdb")
forcefield = ForceField('amber14-all.xml', 'amber14/tip3pfb.xml', 'pfoa/gaff.xml', 'pfoa/pfoa-specific.xml')
...
simulation.reporters.append(PDBReporter('output.pdb', 20000))
